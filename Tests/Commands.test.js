...
describe('runCommand', () => {
	...
	it('if command is type of PLACE command and is valid should call robot.place method', () => {
	...
	it('if command is type of LEFT or RIGHT command and is valid should call robot.place method', () => {
	...
	it('if command is type of MOVE command and is valid should call robot.move method', () => {
	...
	it('if command is type of REPORT command and is valid should call robot.move method', () => {
		const robot = { report: () => {} }
